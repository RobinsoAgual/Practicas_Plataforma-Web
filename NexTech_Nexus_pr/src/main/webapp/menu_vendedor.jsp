...
<center>
   ...
   <ul>
        <li><a href="categoria.jsp">Consultar por Categoria</a></li>
          <li><a href="consulta.jsp">Todos los productos</a></li>
           <li><a href="nuevoProducto.jsp">Ingresar un nuevo Producto</a></li>
